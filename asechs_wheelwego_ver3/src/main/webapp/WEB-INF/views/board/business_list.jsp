...
$(document).ready(function(){
	$("#writeBtn").click(function(){
		location.href="${pageContext.request.contextPath}/afterLogin_board/business_write_form.do";
	})//click
})//ready
</script>
<body>
	<table class="table table-hover">
		<caption><h3>창업게시판 목록</h3></caption>
		<thead>
			<tr>
				<th class="no">NO</th>
	...
	<a href="${pageContext.request.contextPath}/business_list.do?pageNo=${pb.startPageOfPageGroup-1}">
	...
	<a href="${pageContext.request.contextPath}/business_list.do?pageNo=${i}">${i}</a> 
	</c:when>
	<c:otherwise>
	${i}
	</c:otherwise>
	...
	<a href="${pageContext.request.contextPath}/business_list.do?pageNo=${pb.endPageOfPageGroup+1}">
